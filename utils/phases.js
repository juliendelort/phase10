const allPhases = [
    ...
    "7 cards of one color",
    "4 cards of one color + 5 cards of one color",
    "2 sets of 3",
    "1 run of 8",
    "1 run of 9",
    "1 set of 4 + 1 run of 4",
    ...
    "1 run of 3 + 1 set of 4 + 1 set of 2",
    "3 of one color + 3 of one color + 3 of one color",
    "1 color run of 3 + 2 sets of 2",
    "7 of one color",
    "1 set of 3 + 1 set of 3",
    "1 set of 4 + 1 set of 2",
    "1 set of 5",
    "1 run of 9",
    "1 color run of 5 + 1 sets of 3",
    ...
    "3 of one color + 6 of one color",
    "4 of one color + 5 of one color",
    "1 run of 5 + 2 set of 2",
    "1 run of 3 + 1 set of 4 + 1 set of 2",
    "1 run of 8",
    "2 sets of 3",
    "2 sets of 4",
    ...
    "1 color run of 5",
    "4 sets of 2",
    "2 sets of 3 + 1 sets of 2"
];

export function generateNPhases(count) {
    const phasesCopy = [...new Set(allPhases)];
    const result = [];
    for (let i = 0; i < count; i++) {
        if (!phasesCopy.length) {
            return result;
        }
        const randomIndex = Math.round(Math.random() * phasesCopy.length);
        result.push(phasesCopy.splice(randomIndex, 1)[0]);
    }
